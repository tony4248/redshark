...
import com.redshark.ddz.TimedTaskHandler;
...
public class GameDdzTimedTaskEventHandler extends EventHandler {
	public GameDdzTimedTaskEventHandler()
	{
		this.eventType = EventType.GAME_DDZ_TIMED_TASK;
	}
	@Override
