...
import com.redshark.texas.TimedTaskHandler;
...
public class GameTexasTimedTaskEventHandler extends EventHandler {
	public GameTexasTimedTaskEventHandler()
	{
		this.eventType = EventType.GAME_TEXAS_TIMED_TASK;
	}
	@Override
	public void onEvent(Event event)
	{
		...
		try {
			...
			FuncResult funcResult = TimedTaskHandler.processTask(event);
			...
			//发送欢迎信息
			formattedCont = String.format("处理用户:%s:的定时任务%s时发生错误:%s."
